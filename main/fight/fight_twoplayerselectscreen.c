...
static void loadSelector(int i, Position tTextPosition) {
	...
	char path[1024];
	sprintf(path, "assets/main/fight/selectscreen/selector%d.pkg", i);
...
static void loadSelectScreen() {
	...
	gData.mSprites = loadMugenSpriteFileWithoutPalette("assets/main/fight/selectscreen/SELECT.sff");
	gData.mAnimations = loadMugenAnimationFile("assets/main/fight/selectscreen/SELECT.air");
	...
	addCharacter("assets/main/fight/kfm/kfm.def", "assets/main/fight/portraits/kfm.pkg", "Kung-fu Man", makePosition(80, 150, 5));
	addCharacter("assets/main/fight/Beat/Beat.def", "assets/main/fight/portraits/beat.pkg", "Beat", makePosition(240, 150, 5));
	addCharacter("assets/main/fight/Sonicth/Sonicth.def", "assets/main/fight/portraits/sonic.pkg", "Sonic", makePosition(400, 150, 5));

	gData.mHalfSelector = loadTexture("assets/main/fight/selectscreen/selectorhalf.pkg");
